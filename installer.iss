[Setup]
AppName=OpenHam Logger 0.4.0
AppVersion=0.4.0
DefaultDirName={autopf}\OpenHam
DefaultGroupName=OpenHam
OutputDir=.\releases
OutputBaseFilename=OpenHam_Setup_0.4.0
Compression=lzma
SolidCompression=yes
SetupIconFile=source\gui\logo.ico

[Files]
; 1. Copy the main executable
Source: "dist\OpenHam Logger 0.4.0\OpenHam Logger 0.4.0.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "dist\OpenHam Logger 0.4.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Icons]
Name: "{group}\OpenHam"; Filename: "{app}\OpenHam_Logger 0.4.0.exe"
Name: "{autodesktop}\OpenHam"; Filename: "{app}\OpenHam_Logger 0.4.0.exe"; Tasks: desktopicon
